...
var getEntityLength =function (entitys) {
    var count=0;
    if (var id in entitys) {
        count++;
    }
    return count;
};
...
attack = function(entity) {
    ...
    if (entity.type === 'player' || entity.type === 'mob') {
        ...
        var msg = {route:route,areaId:areaId,playerId: pomelo.playerId, targetId:attackId, skillId: skillId};
        ...
        var attackId = entity.entityId;
        var msg = {route:route, areaId:pomelo.areaId, playerId:pomelo.playerId, targetId:attackId};
